...
def mock_logging_for_tests():
    ...
    with patch("src.alfred.lib.logger.setup_task_logging"), patch("src.alfred.lib.logger.cleanup_task_logging"):
        yield
...
class AlfredTestProject:
    ...
    def __init__(self, root_path: Path):
        ...
        self.settings = Settings(project_root=self.root, alfred_dir_name=".alfred-test")
