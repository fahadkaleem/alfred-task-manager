...
class TestSubmitWork:
    ...
    def test_submit_work_validation_failure(self):
        ...
        test_task = Task(task_id=task_id, title="Test Task for Validation", context="Testing artifact validation failure", implementation_details="Verify validation errors are properly handled")
