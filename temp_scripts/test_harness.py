...
class ValidationTestHarness:
    ...
    def test_workflow_tools(self) -> None:
        ...
        try:
            ...
            has_all_checks = all(key in consistency_check for key in ["task_state_exists", "tool_state_exists", "state_file_exists"])
    ...
    def test_error_handling(self) -> None:
        ...
        try:
            ...
            details = f"Total error tests: {error_summary['total_error_tests']}, Success rate: {error_summary['success_rate']:.1f}%"
